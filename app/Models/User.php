...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsToMany(Collection::class, 'collection_shares')
            ->withPivot('permission_level', 'accepted_at', 'shared_by_user_id')
            ->withTimestamps()
            ->whereNotNull('collection_shares.accepted_at');
    }

    public function sharedByMe(): HasMany
    {
        return $this->hasMany(CollectionShare::class, 'shared_by_user_id');
    }
}
